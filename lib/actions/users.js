...
function readForm(formData) {
  return {
    ...
    isWholesaleApproved: formData.get('isWholesaleApproved') === 'on',
  }
}

/** The module moved from Users to Customers; both URLs stay valid. */
function revalidateLists(id) {
  for (const base of ['/admin/customers', '/admin/users']) {
    revalidatePath(base)
